...
public class JdbcDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String insertQuery = "insert into Emp values(101,'javeed',70000,'2025-01-19')";
			
			//int eid = 101; String name = "tom"; double sal = 4000;
			
			
			//String insertQuery2 = "insert into Emp values("+eid+","+name+","+sal+"")";
